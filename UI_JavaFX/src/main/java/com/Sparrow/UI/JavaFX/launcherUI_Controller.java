...
import com.Sparrow.Tools.Download.Download;
...
import com.Sparrow.Tools.dialog.inputDialog;
 ...
 */
public class launcherUI_Controller implements com.Sparrow.UI.launcherUI_ControllerI {
    ...
    public void install() {
        ...
        launcher.gameProcessListener = new GameProcessListener() {
            ...
            public void onExit(int code) {
                ...
                try {
                    SystemPlatform.displayTray("Sparrow - 游戏结束", "游戏进程结束", "返回码：" + code);
        ...
        launcher.combinedDownloadCallback = new CallbackAdapter<Version>() {
            ...
            public void done(Version result) {
                ...
                try {
                    SystemPlatform.displayTray("Sparrow - 下载完成", "下载完成", "恭喜。MC版本：" + result + "已下载完成。");
                } catch (AWTException awtException) {
                }
            }
            ...
            public void failed(Throwable e) {
                ...
                appendLog("下载出现错误。");
                try {
                    SystemPlatform.displayTray("Sparrow - 下载错误", "下载错误", "抱歉。下载MC时遇到错误：" + e.toString());
                } catch (AWTException awtException) {
                }
                e.printStackTrace();
            }
        ...
        appendLog("轻巧、便捷为一体，尽在 Sparrow · 新一代MC启动器 。加载完毕。");
    ...
    /**
     * @return 返回用户指定的玩家名。如果未指定，则返回缺省值“Sparrow”。
     * @author XiaoLi8848, 1662423349@qq.com
     */
    @Override
    public String getPlayerName() {
        return playerName.getText().length() > 0 ? playerName.getText() : "Sparrow";
    }
    ...
    public void showAbout() {
        ...
        primaryStage.setTitle("Sparrow - About");
        FXMLLoader a = new FXMLLoader(getClass().getClassLoader().getResource("com.Sparrow.UI/JavaFX/launcherUI_javafx_about.fxml"));
        Parent root = null;
        try {
            root = a.load();
        } catch (IOException e) {
