...
public class launcherUI_JavaFX extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        primaryStage.setTitle("Sparrow");
        //Parent root = FXMLLoader.load(com.Sparrow.launcher.class.getResource("launcherUI_h5.fxml"));
        controller = new launcherUI_Controller_JavaFX();
        Scene scene = new Scene(controller.browserView, 1000, 850);
        primaryStage.setScene(scene);
        primaryStage.initStyle(StageStyle.UNDECORATED);
        primaryStage.show();
        controller.loadURL(getClass().getClassLoader().getResource("com/Sparrow/UI/H5/webapp/index.html").toString());
    }
}
